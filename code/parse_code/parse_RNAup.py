...
def parse_RNAup(result_path, rri_pair, seq1_len,seq2_len):
    # dotresult
    ...
    if seq1_len < seq2_len:
        invers_pair = [[pair[1],pair[0]] for pair in predict_pair]
    else:
        invers_pair  = predict_pair

    # print(rri_pair)
    for pair in invers_pair:
